...
[mag(1,:), phs(1,:)] = bode(quadResp(12,21),w);
H15 = mag .* exp(i.*phs*pi/180);

[mag(1,:), phs(1,:)] = bode(quadResp(12,1),w);
H16 = mag .* exp(i.*phs.*pi/180);

[mag(1,:), phs(1,:)] = bode(quadResp(10,1),w);
H17 = mag .* exp(i.*phs*pi/180);

[mag(1,:), phs(1,:)] = bode(quadResp(10,21),w);
H18 = mag .* exp(i.*phs.*pi/180);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Transfer Function UIM Servo -> PM
%  This is also the openloop TF
H19 = H11 ./ H16;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Transfer Function PM -> UIM Force Feedback
H20 = 1 ./ H14;
...
X_PRN_noise = 10e-12 .* ones(size(f));  
...
I_OSEM_UIM_rms = rms(f, I_OSEM_UIM);
